...
export default function Edit() {
    ...
    return (
        <section className="h-screen flex flex-col justify-center items-center gap-10 p-10">
            <h2 className="text-[28px]">Atualizar tarea</h2>
            <form className="bg-slate-800 p-10 rounded" onSubmit={handleSubmit}>
                ...
                <input type="submit" value="Actualizar" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded cursor-pointer" />
            </form>
